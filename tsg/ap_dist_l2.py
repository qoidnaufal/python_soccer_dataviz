...
TOTAL_MINUTES_L2_PLAYOFF = 11 * 28 * 90 * 10
...
foreign_regular = foreign.loc[~foreign['Team'].isin(PLAYOFF_TEAMS)]
...
foreign_minutes = foreign_regular_minutes + foreign_playoff_minutes
foreign_contribution = foreign_regular_contribution + foreign_playoff_contribution
...
adjusted_regular_ap_minutes = ap_regular['Adj Minutes in Liga 2 Regular Teams'].sum()
...
adjusted_playoff_ap_minutes = ap_playoff['Adj Minutes in Liga 2 Playoff Teams'].sum()
playoff_ap_contribution = adjusted_playoff_ap_minutes / TOTAL_MINUTES_L2_PLAYOFF

total_adjusted_ap_minutes = adjusted_regular_ap_minutes + adjusted_playoff_ap_minutes
adjusted_ap_contribution = regular_ap_contribution + playoff_ap_contribution
...
non_ap_players_minutes = TOTAL_MINUTES_L2_PLAYOFF - foreign_minutes - total_adjusted_ap_minutes
non_ap_contribution = non_ap_players_minutes / TOTAL_MINUTES_L2_PLAYOFF
